...
?>
    ...
    <div class="container col-9 rounded-0 d-flex justify-content-between">
        <div class="col-8">
            ...
            showError('post_img');
            if(count($posts)<1){
                echo "<p class='p-2 bg-white border shadow rounded text-center my-3'>Follow someone or Upload a new post.</p>";
            }
            ...
            foreach($posts as $post){
                ...
                <h4 style="font-size: 20px" class="p-2 border-bottom">
                <span>
                <?php
                    ...
                    if(checkLikeStatus($post['id'])){
                        ...
                        ?>
                                          ...
                                          <i class="bi bi-hand-thumbs-up-fill unlike_btn" style="display: <?=$unlike_btn_display?>" data-post-id='<?=$post['id']?>'></i>
                                          <i class="bi bi-hand-thumbs-up like_btn" style="display: <?=$like_btn_display?>" data-post-id='<?=$post['id']?>'></i>
<span class="" data-bs-toggle="modal" data-bs-target="#likes<?=$post['id']?>"><?=count($likes)?> likes</span> 
               
                &nbsp;&nbsp;<i
                        class="bi bi-chat-left"></i>
                        <span class="" data-bs-toggle="modal" data-bs-target="#postview<?=$post['id']?>"><?=count($comments)?> comments</span>
...
<p>Currently no likes
        ...
        <div class="d-flex align-items-center p-2">
            ...
            <div>
                ...
                <?php
                foreach($follow_siggestions as $suser){
                    ?>
                ...
                if(count($follow_siggestions)<1){
                    echo "<p class='p-2 bg-white border shadow rounded text-center'>Currently no suggestion for you.</p>";
                }
                ?>
